		...
		<div class="social_icon">
			<div class="container">
				...
				<div class="header_right">
					<div class="login ">
						<a href="#"><?php echo $_SESSION['f_name']; ?></a>
					</div>

					<a href="my_order.php"><div class="cart_btn">
		...
		<div class="container">
			...
			<div class="product_one">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=1" method="post"><button type="submit" name="submit">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_two">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=2" method="post"><button type="submit" name="submit2">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_three">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=3" method="post"><button type="submit" name="submit3">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_four">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=4" method="post"><button type="submit" name="submit4">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_five">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=5" method="post"><button type="submit" name="submit5">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_six">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=6" method="post"><button type="submit" name="submit6">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_seven">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=7" method="post"><button type="submit" name="submit7">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_eight">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=8" method="post"><button type="submit" name="submit8">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_nine">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=9" method="post"><button type="submit" name="submit9">ADD TO CART</button></form>
					</div>
				</div>
			</div>
			...
			<div class="product_ten">
				...
				<div class="product_price">
					...
					<div class="button">
						<form action="item-add.php?item=10" method="post"><button type="submit" name="submit10">ADD TO CART</button></form>
					</div>
				</div>
			</div>
